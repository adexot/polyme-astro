...
const meta: Meta<typeof BrushBarChart> = {
  title: 'Components/BrushBarChart',
...
export default meta;
type Story = StoryObj<typeof BrushBarChart>;
...
export const Default: Story = {
  args: {
    data: sampleData,
    title: 'Activity Difference Over Time (Brush)',
    height: 400,
    showLegend: true,
    showGrid: true,
  },
...
export const LargeDataset: Story = {
  args: {
    data: manyDataPoints,
    title: 'Many Data Points with Brush',
    height: 450,
    showLegend: true,
    showGrid: true,
  },
